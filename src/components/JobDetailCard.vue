                ...
                <div class="card-body">
                    ...
                    <form class="form-sample">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" min="0" max="59" v-model="job.interval_seconds" :placeholder="job.interval_seconds" :disabled="disableEdit(job.scheduler_type, 'interval_seconds')">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" min="0" :placeholder="job.interval_minutes" v-model="job.interval_minutes" :disabled="disableEdit(job.scheduler_type, 'interval_minutes')">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" min="0" max="23" :placeholder="job.hours" v-model="job.hours" :disabled="disableEdit(job.scheduler_type, 'hours')">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" min="0" max="59" :placeholder="job.minutes" v-model="job.minutes" :disabled="disableEdit(job.scheduler_type, 'minutes')">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" max="30" :placeholder="job.day_of_month" v-model="job.day_of_month" :disabled="disableEdit(job.scheduler_type, 'day_of_month')">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">CronTab</label>
                                    <div class="col-sm-4">
                                        <div class="form-radio">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="cronEnable" id="cron1" value="option1" :checked="job.cron_enable===true" @change="onChangeEnableCron"> Enable
                                                <i class="input-helper"></i></label>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="form-radio">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="cronEnable" id="cron2" value="option2" :checked="job.cron_enable===false" @change="onChangeEnableCron"> Disable
                                                <i class="input-helper"></i></label>
                                        </div>
                                    </div>
                                </div>
...
<!--                                     <label class="col-sm-3 col-form-label">Cron Expression</label> -->
                                    <div class="col-sm-9">
                                        <input type="hidden" class="form-control" :placeholder="job.cron" v-model="job.cron">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" v-model="cron.second" @change="updateCronExpression">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" v-model="cron.minute" @change="updateCronExpression">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" v-model="cron.hour" @change="updateCronExpression">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Day (month)</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" v-model="cron.day" @change="updateCronExpression">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" v-model="cron.month" @change="updateCronExpression">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Day (week)</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" v-model="cron.day_week" @change="updateCronExpression">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" v-model="cron.year" @change="updateCronExpression">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
export default {
    ...
    methods: {
        ...
        updateCronExpression() {
          this.job.cron = this.cron.second + ' ' + this.cron.minute + ' ' + this.cron.hour + ' ' 
          + this.cron.month + ' ' + this.cron.day_week + ' ' + this.cron.year
        }
    }
}
</script>